...
namespace Cookie.InputHelper
{
    ...
    public class RebindingUI_Action : MonoBehaviour
    {
        ...
        [SerializeField] private GameObject rebindingScreen = null;
        [SerializeField] private TMP_Text rebindingScreenText = null;
        ...
        private void PerformRebind(IEnumerator<int> indices) {
            ...
            action.action.PerformInteractiveRebinding(index)
                .WithTimeout(timeout)
                ...
                .OnComplete(op => {
                        ...
                        if (!binding.isPartOfComposite) return;
            ...
            void Cleanup(InputActionRebindingExtensions.RebindingOperation op) {
                ...
                InputUtils.SaveBinds(action.action.actionMap);
                if (wasEnabled) action.action.Enable();
            }
        }
        ...
        private void UpdateDisplay() {
            ...
            string displayString = InputUtils.GetBindingDisplayString(action.action, bindingIndex, out _, out _);
            if (bindingLabel) bindingLabel.text = displayString;
        }
    }
}