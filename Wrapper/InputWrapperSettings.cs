...
namespace Cookie.InputHelper
{
    internal class InputWrapperSettings : ScriptableObject
    {
        ...
        [SerializeField]
        [Tooltip("The namespace for the wrapper classes. Leave empty for no namespace")]
        ...
        [SerializeField]
        [Tooltip("The assets to generate the wrapper classes for")]
        ...
        internal static InputWrapperSettings GetInst()
        {
            ...
            if (AssetDatabase.AssetPathExists(path))
                return AssetDatabase.LoadAssetAtPath<InputWrapperSettings>(path);
        ...
        {
            [SerializeField]
            [Tooltip("The class name for the generated wrapper")]
